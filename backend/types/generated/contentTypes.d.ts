...
export interface ApiCartCart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bought: Schema.Attribute.Boolean;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    paymentState: Schema.Attribute.Enumeration<['pendiente', 'exito', 'fallo']>;
    publishedAt: Schema.Attribute.DateTime;
    shippingAddres: Schema.Attribute.JSON;
    slug: Schema.Attribute.UID;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    priceOffer: Schema.Attribute.Decimal;
...
export interface ApiWishItemWishItem extends Struct.CollectionTypeSchema {
...
export interface ApiWishlistWishlist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    wishItems: Schema.Attribute.Relation<
      'oneToMany',
      'api::wish-item.wish-item'
    >;
  };
  ...
  attributes: {
    ...
    number: Schema.Attribute.BigInteger &
      ...
      Schema.Attribute.SetMinMax<
        ...
        string
      > &
      Schema.Attribute.DefaultTo<'3000000000'>;
